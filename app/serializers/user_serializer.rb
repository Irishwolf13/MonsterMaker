class UserSerializer < ActiveModel::Serializer
  attributes :id, :first_name, :last_name, :full_name, :phone, :age, :username, :email, :location, :password_digest, :user_image, :dinner_partners, :my_interests, :reservations_joined, :reservations
